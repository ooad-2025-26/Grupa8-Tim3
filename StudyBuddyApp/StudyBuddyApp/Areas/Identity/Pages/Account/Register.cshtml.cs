...
namespace StudyBuddyApp.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required]
            [StringLength(100, ErrorMessage = "Lozinka mora imati najmanje {2}, a najviše {1} znakova.", MinimumLength = 6)]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                user.Uloga = TipUloge.Student;
                user.StatusNaloga = StatusNaloga.Aktivan;
